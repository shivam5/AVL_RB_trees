...
public:
    ...
    node <E> * firstEntry();
    node <E> * lastEntry();
    node <E> * ceilingEntry (int k);
    node <E> * floorEntry (int k);
    node <E> * lowerEntry (int k);
    node <E> * higherEntry (int k);
    int size();
    bool empty();
    node <E> * find(int k);
...
template <typename E>
bool avltree <E> :: targetsum (int target ){
    node <E> *left=min(root);
    node <E> *right=max(root);
    
    while (left->key<right->key){
        if (left->key + right->key == target){
            cout<<"("<<left->key<<" + "<<right->key<<") = "<<target;
            return true;
        }
...
template <typename E>
node <E> * avltree <E> :: ceilingEntry (int k){
    node <E> * t=find(k);
    if (t->key == k)
        return t;
    else
        return higherEntry(k);
}

template <typename E>
node <E> * avltree <E> :: floorEntry (int k){
    node <E> * t=find(k);
    if (t->key == k)
        return t;
    else
...
template <typename E>
node <E> * avltree <E> :: lowerEntry (int k){
    E q;
    node <E> * t=find(k);
    node <E> *u;
...
template <typename E>
node <E> * avltree <E> :: higherEntry (int k){
    E q;
